 ...
 * The returned instance must be destroyed by the caller.
 *
 * @param rpkOrResURI               URI to the rpk or the resource, see \ref AppNotes for URI creation.
 * @param unpackRPKToFileSystemPath Optional. If non-null, the rpk / resource gets unpacked to the given directory in the filesystem
