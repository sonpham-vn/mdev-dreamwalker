 ...
 * CGA array attributes can be 2 dimensional. If an array attribute has more than 1 row, an additional int attribute is present, containing the number of rows.
 * Its name is /arrayDimRows/\<array attr name\>.
 *
